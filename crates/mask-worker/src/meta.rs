...
///
/// `keywords` is encoded as a JSON array (VGI138). `category` names one of the
/// schema's `vgi.categories` (VGI413), driving navigation/listing. Provenance is
/// intentionally omitted here and lives only on the catalog object (VGI139).
pub fn object_tags(
    title: &str,
    doc_llm: &str,
    doc_md: &str,
